...
import { incrementLikes,decrementLikes } from "./postSlice";
import { incrementLikes1,decrementLikes1,addLikesToPost,removeLikesToPost } from "../user/userSlice";
...
const LikeButton = ({post}) => {
  ...
  return (
    <div onClick={()=>handleClick()} className="flex items-center justify-start w-[25%] h-full gap-1 border-r-2 dark:border-r-[1px] dark:border-r-gray-400 cursor-pointer hover:text-blue-500 dark:text-gray-100">
