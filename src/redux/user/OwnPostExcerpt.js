...
const OwnPostExcerpt = ({ post }) => {
  ...
  return (
    <div className="h-full w-full flex flex-col gap-2 rounded-lg lg:flex-grow bg-slate-50 lg:bg-white dark:bg-slate-600">
      ...
      <div className="h-full w-full flex flex-col gap-1 dark:bg-slate-600  text-gray-700 dark:text-gray-100 lg:flex-grow ">
